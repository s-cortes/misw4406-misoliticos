...
def register_handlers():
    import propiedades.modules.contratos.application

def import_alchemy_models():
    import propiedades.modules.contratos.infrastructure.dto
...
def consume():
    ...
    import threading
    import propiedades.modules.contratos.infrastructure.consumers as contratos


    # Suscripción a eventos
    threading.Thread(target=contratos.subscribe_to_events).start()


    # Suscripción a comandos
    threading.Thread(target=contratos.subscribe_to_commands).start()
